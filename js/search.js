...
//		if (!out[bkid]) {
		...
		//慧日的所有課程
		var aBook = ["十住毘婆沙論","大乘廣五蘊論","大乘廣五蘊論講記","大智度論","中阿含經選讀","中論","中觀今論","印度佛教史","如來藏之研究","成佛之道","佛在人間","佛法概論","妙雲集選讀","初期大乘佛教之起源與開展","空之探究","阿含經","青年的佛教","修定——修心與唯心．秘密乘","俱舍論","般若經講記","淨土學論集","華雨集選讀","學佛三要","雜阿含經論會編","寶積經講記","摩訶般若波羅蜜經"];
